<template>
  <el-form label-width="100px">
    ...
    <el-form-item label="SPU销售属性">
      <!-- 展示销售属性的下拉菜单-->
      <el-select v-model="saleAttrIdAndValueName" class="widthStyle"
...
import type { SaleAttrValue, SpuData, AllTradeMark, SpuHasImg, SaleAttrResponseData, Trademark, SpuImg, SaleAttr, HasSaleAttr, HasSaleAttrResponseData } from '@/api/product/spu/type';
