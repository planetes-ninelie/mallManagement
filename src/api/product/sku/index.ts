...
//展示SKU数据的接口
export const reqSku = (page: number, limit: number) => request.get<any,HasSkuResponseData>(API.GETSKU_URL + `${page}/${limit}`)

//获取SKU数据详情的接口
export const reqSkuInfo = (skuId :number) => request.get<any,any>(API.GETSKUINFO_URL + skuId)
